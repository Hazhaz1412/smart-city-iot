...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DATABASE_NAME', 'smartcity_db'),
...
REST_FRAMEWORK = {
    'DEFAULT_RENDERER_CLASSES': [
        ...
        'entities.renderers.JSONLDRenderer',
    ],
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'accounts.authentication.DeviceAPIKeyAuthentication',  # Check device API key first
...
CORS_ALLOW_HEADERS = [
    ...
    'x-csrftoken',
    'x-requested-with',
    'x-device-api-key',  # For IoT device authentication
]
...
ORION_LD_API_VERSION = os.getenv('ORION_LD_API_VERSION', 'v2')
...
CUSTOM_CONTEXT_URL = "http://localhost:8000/api/v1/context"
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'logs/smartcity.log',
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
